...
public class FButton extends android.support.v7.widget.AppCompatButton implements View.OnTouchListener {
    ...
    protected void onFinishInflate() {
        ...
        //Update vcc.cretivemindsz.kumar.background color
        refresh();
    }
    ...
    public void refresh() {
        ...
        //Create pressed vcc.cretivemindsz.kumar.background and unpressed vcc.cretivemindsz.kumar.background drawables
    ...
    private void updateBackground(Drawable background) {
        ...
        //Set button vcc.cretivemindsz.kumar.background
